...
import { WhisperCppProvider } from './transcription/whisperCpp.js';
import { FasterWhisperProvider } from './transcription/fasterWhisper.js';
import { WhisperWasmProvider } from './transcription/whisperWasm.js';
import { WebSpeechProvider } from './transcription/webSpeech.js';

// Priority order exactly as specified: local, compiled, fast engines first;
// the browser's built-in (non-offline) engine only as a last resort.
const PROVIDER_CHAIN = [WhisperCppProvider, FasterWhisperProvider, WhisperWasmProvider, WebSpeechProvider];
